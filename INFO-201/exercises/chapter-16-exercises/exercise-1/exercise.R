...
ggplot(data = diamonds_sample, aes(x = carat, y = price)) + geom_point()
...
ggplot(data = diamonds_sample, aes(x = carat, y = price, shape = cut)) + 
  geom_point(color = "blue")

# Draw a scatter plot for `diamonds_sample` of *`cut`* by `carat`, where each
# point has an aesthetic _size_ based on the diamond's *`price`*
ggplot(data = diamonds_sample, aes(x = carat, y = cut, size = price)) + 
  geom_point(color = "blue")
...
ggplot(data = diamonds_sample, aes(x = cut, y = price)) + 
